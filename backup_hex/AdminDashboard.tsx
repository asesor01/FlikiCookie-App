      ...
      <html>
        <head>
          ...
          <style>
            ...
            .box { border: 1px solid #D9C5B2; padding: 12px; margin: 15px 0; background: #FAF7F2; font-size: 12px; }
        ...
        <body>
          <div class="header">
            <div>
              ...
              <div style="font-size: 12px; color: #8C7A6B;">Cusco, Perú</div>
            </div>
            <div class="timestamp">
        ...
        <body>
          <div class="header">
            ...
            <div class="invoice-box">
              ...
              <p style="color: #523A2A; margin-top: 6px;">R.U.C. N° 20601234567</p>
              <p style="color: #C25E00; font-size: 15px; margin-top: 4px;">${invoiceNum}</p>
            </div>
          </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 15px; margin-bottom: 30px;">
          <thead>
            <tr style="background-color: #FAF7F2;">
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: left; font-size:11px;">ID</th>
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: left; font-size:11px;">Cliente</th>
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: left; font-size:11px;">Fecha/Hora</th>
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: left; font-size:11px;">Despacho</th>
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: left; font-size:11px;">Productos</th>
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: left; font-size:11px;">Método Pago</th>
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: left; font-size:11px;">Estado</th>
              <th style="padding: 10px; border-bottom: 2px solid #EAE0D5; text-align: right; font-size:11px;">Total</th>
            </tr>
          </thead>
          <tbody>
            ${activeOrders.map(o => `
            ...
            <tr style="background-color: #FAF7F2; font-weight: bold;">
              ...
              <td style="padding: 10px; text-align: right; font-size:12px; color: #3D2B1F;">S/. ${totalActiveAmount.toFixed(2)}</td>
            </tr>
          </tbody>
        </table>
      `;
      ...
      htmlContent += `
        <div style="page-break-before: ${type === 'all' ? 'always' : 'avoid'};">
          ...
          <div style="display: flex; gap: 20px; margin-bottom: 25px;">
            <div style="flex: 1; border: 1px solid #EAE0D5; padding: 15px; border-radius: 6px; background-color: #FAF8F5;">
              <h4 style="margin-top:0; color: #3D2B1F; border-bottom: 1px solid #EAE0D5; padding-bottom:5px; font-size:13px;">🌾 Insumos Secos e Ingredientes Base</h4>
            ...
            <div style="flex: 1; border: 1px solid #EAE0D5; padding: 15px; border-radius: 6px; background-color: #FAF8F5;">
              <h4 style="margin-top:0; color: #3D2B1F; border-bottom: 1px solid #EAE0D5; padding-bottom:5px; font-size:13px;">🎨 Masas Premium y Rellenos</h4>
              <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
                <thead>
                  <tr style="border-bottom: 1px solid #EAE0D5;">
      ...
      htmlContent += `
        <div style="page-break-before: ${type === 'all' ? 'always' : 'avoid'};">
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
            <thead>
              <tr style="background-color: #FAF7F2;">
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Pedido ID</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Cliente / Cel</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Forma Entrega</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Dirección de Envío</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Hora Pactada</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Método Pago</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:right;">Cobro</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:center; width:120px;">Firma de Recibido</th>
              </tr>
            </thead>
            <tbody>
              ${activeOrders.map(o => `
                <tr style="border-bottom: 1px solid #FAF7F2; height: 35px;">
    ...
    if (type === "stats" || type === "all") {
      ...
      htmlContent += `
        <div style="page-break-before: ${type === 'all' ? 'always' : 'avoid'};">
          ...
          <div style="border: 1px solid #EAE0D5; border-radius: 6px; padding: 20px; background-color:#FAF8F5; margin-bottom: 25px;">
            <h4 style="margin-top:0; color:#3D2B1F; font-size:13px; margin-bottom:15px;">📊 Comparativa de Ventas Mensuales (Gráfico de Barras)</h4>
            <div style="display: flex; align-items: flex-end; height: 160px; gap: 25px; border-left: 2px solid #EAE0D5; border-bottom: 2px solid #EAE0D5; padding: 10px 15px; margin-top: 10px;">
              ${Object.keys(monthlySales).map(m => {
                ...
                return `
                  <div style="flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: flex-end; height: 100%;">
                    ...
                    <div style="width: 100%; max-width: 45px; height: ${heightPct}%; background-color: #3D2B1F; border-radius: 4px 4px 0 0;"></div>
                    <span style="font-size: 10px; margin-top: 6px; font-weight: bold; color: #8C7A6B;">${m}</span>
                  </div>
                `;
              }).join('')}
            </div>
          ...
          <div style="border: 1px solid #EAE0D5; border-radius: 6px; padding: 15px; background-color:#FAF8F5;">
            <h4 style="margin-top:0; color:#3D2B1F; font-size:13px; margin-bottom:10px;">🍪 Ranking de Especialidades & Sabores Preferidos</h4>
            <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
              <thead>
                <tr style="border-bottom: 1px solid #EAE0D5;">
      ...
      htmlContent += `
        <div style="page-break-before: ${type === 'all' ? 'always' : 'avoid'};">
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
            <thead>
              <tr style="background-color: #FAF7F2;">
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">ID</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Nombre Comercial</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Contacto Principal</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Celular / WhatsApp</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Correo Electrónico</th>
                <th style="padding: 8px; border-bottom: 2px solid #EAE0D5; text-align:left;">Insumos Suministrados</th>
              </tr>
            </thead>
            <tbody>
              ${providers.map(p => `
                <tr style="border-bottom: 1px solid #FAF7F2;">
                  ...
                  <td style="padding: 6px; font-weight:bold; color: #8C7A6B;">${p.suppliedItems.join(', ')}</td>
                </tr>
              `).join('')}
            </tbody>
          </table>
  ...
  if (!isAuthorized) {
    return (
      <div className="flex items-center justify-center py-16 px-4 animate-fade-in" id="admin_lock_screen">
        <div className="bg-white border-2 border-[#E5A84B] p-8 rounded-xl max-w-md w-full shadow-lg space-y-6 text-center">
          <div className="w-16 h-16 bg-[#E91E8C] text-white rounded-full flex items-center justify-center mx-auto shadow-md animate-pulse">
            <Lock className="w-7 h-7 text-white" />
          </div>
          <div className="space-y-2">
            <h3 className="font-serif font-bold text-2xl text-[#1A0F0A]">Acceso de Maestros</h3>
            <p className="text-sm text-[#2D1F15] leading-relaxed font-medium">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1 text-left">
              <label className="text-[12px] font-bold uppercase tracking-wider text-[#1A0F0A] block">Contraseña de Seguridad</label>
              <input
                type="password"
                value={passwordInput}
                onChange={(e) => setPasswordInput(e.target.value)}
                placeholder="••••••••"
                className="w-full bg-white border border-[#E5A84B] text-[#1A0F0A] text-sm rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#E91E8C] placeholder-[#5D4E37] font-bold"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-[#E91E8C] text-white hover:bg-[#D1177D] font-bold py-3.5 px-4 rounded-xl text-sm tracking-wider uppercase transition-all shadow-md cursor-pointer"
            >
              Iniciar Sesión
            </button>
          </form>

          <div className="bg-[#FAF2EB] border border-[#E5A84B]/40 p-4 rounded-xl text-left">
            <p className="text-[12px] text-[#2D1F15] font-semibold leading-relaxed">
              🔑 <strong>Clave por defecto:</strong> <code className="bg-white px-2 py-0.5 rounded border border-[#E5A84B] font-bold font-mono text-[13px]">{`admin123`}</code> <span className="text-[#5D4E37] font-normal">(Puedes modificarla en la pestaña ⚙️ Configuración).</span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-8 animate-fade-in" id="admin_dashboard_root">
        ...
        <div className="flex overflow-x-auto gap-2" style={{ scrollbarWidth: 'thin' }}>
          ...
          >
            ...
            {whatsappConversations.filter(c => c.unreadCount > 0).length > 0 && (
              <span className="ml-1 px-1.5 py-0.5 text-[9px] font-sans font-extrabold bg-[#25D366] text-white rounded-full">
      ...
      {activeTab === "orders" && (
        <div className="space-y-8 animate-fade-in" id="admin_tab_orders">
          ...
          <div className="bg-art-text text-white rounded-lg p-6 shadow-md border border-art-text">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="space-y-1">
                <h3 className="font-serif font-bold text-lg tracking-tight flex items-center gap-2 text-[#EAD8C3]">
                  <Sparkles className="w-5 h-5 animate-pulse fill-[#EAD8C3]" /> Co-Piloto de Repostería de IA
                </h3>
                <p className="text-xs text-[#D1C3B7] max-w-xl leading-relaxed">
              ...
              <button
                ...
                className="bg-art-accent hover:bg-art-accent/90 disabled:bg-[#4E3C30] disabled:text-[#8C7A6B] text-white font-bold text-xs px-5 py-3 rounded-lg transition-all shadow-md shrink-0 flex items-center gap-2 cursor-pointer"
                id="btn_ai_analysis"
              >
                {isAnalyzing ? (
                  <>
            ...
            {/* AI Analysis Display */}
            {isAnalyzing && (
              <div className="mt-6 border-t border-[#543E2F] pt-6 flex flex-col items-center justify-center py-8 text-center space-y-3">
                <Coffee className="w-8 h-8 text-art-accent animate-bounce" />
                <div className="space-y-1">
                  <p className="text-xs font-semibold text-[#EAD8C3]">Consolidando masa, mermeladas y decoraciones...</p>
                  <p className="text-[10px] text-[#C4B4A5]">El Chef de IA está evaluando los tiempos de horneado y alérgenos de seguridad.</p>
                </div>
              </div>
            )}

            {analysisResult && !isAnalyzing && (
              <div className="mt-6 border-t border-[#543E2F] pt-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-[#EAD8C3] animate-fade-in" id="ai_analysis_result">
                {/* Left */}
                <div className="space-y-5">
                  <div className="bg-[#4D3A2C] border border-[#5C4839] rounded-lg p-4 space-y-3">
                    ...
                    <ol className="space-y-2 text-xs">
                      {analysisResult.schedule.map((task, i) => (
                        <li key={i} className="flex gap-2 text-[#E6DBD0]">
                  ...
                  <div className="bg-[#4D3A2C] border border-[#5C4839] rounded-lg p-4 space-y-3">
                    ...
                    <ul className="space-y-1.5 text-xs text-[#E6DBD0] list-disc list-inside">
                ...
                <div className="space-y-5">
                  <div className="bg-[#4D3A2C] border border-[#5C4839] rounded-lg p-4 space-y-3">
                    <h4 className="text-xs font-bold text-[#FFB6C1] uppercase tracking-wider flex items-center gap-1.5">
                  ...
                  <div className="bg-[#4D3A2C] border border-[#5C4839] rounded-lg p-4 space-y-3">
                    ...
                    <div className="space-y-2">
                      {analysisResult.warnings.map((warn, i) => (
                        <div key={i} className="flex gap-2 text-xs text-[#E6DBD0] bg-red-950/20 border border-red-900/40 p-2.5 rounded-lg">
      ...
      {activeTab === "metrics" && (
        <div className="space-y-6 animate-fade-in" id="admin_tab_metrics">
                  ...
                  >
                    <defs>
                      <linearGradient id="metricsGradient" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="#C25E00" stopOpacity={0.4}/>
                        <stop offset="95%" stopColor="#C25E00" stopOpacity={0}/>
                      </linearGradient>
                    </defs>
                    <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f0f0f0" />
                    <XAxis dataKey="date" tick={{ fontSize: 10, fill: '#8C7A6B' }} />
                    <YAxis tick={{ fontSize: 10, fill: '#8C7A6B' }} />
                    <Tooltip 
                      formatter={(val: any) => [`S/. ${Number(val).toFixed(2)}`, "Ingresos"]}
                      contentStyle={{ backgroundColor: '#FAF7F2', borderColor: '#D9C5B2', borderRadius: '8px', fontSize: '11px' }}
                    />
                    <Area type="monotone" dataKey="ventas" stroke="#C25E00" strokeWidth={2.5} fillOpacity={1} fill="url(#metricsGradient)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
              ...
              <div className="h-64 w-full text-xs" style={{ minHeight: '250px' }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={getTopProductsChartData()} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
                    ...
                    <XAxis type="number" tick={{ fontSize: 10, fill: '#8C7A6B' }} />
                    <YAxis dataKey="name" type="category" tick={{ fontSize: 10, fill: '#523A2A' }} width={120} />
                    <Tooltip formatter={(val: any) => [`${val} unidades`, "Vendidos"]} />
                    <Bar dataKey="cantidad" fill="#523A2A" radius={[0, 4, 4, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
              ...
              <div className="h-64 w-full text-xs" style={{ minHeight: '250px' }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={getPaymentMethodsChartData()} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f0f0f0" />
                    <XAxis dataKey="name" tick={{ fontSize: 10, fill: '#8C7A6B' }} />
                    <YAxis tick={{ fontSize: 10, fill: '#8C7A6B' }} />
          ...
          <div className="bg-art-panel border border-art-border rounded-xl p-6 space-y-4 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#D9C5B2] pb-3">
              <div>
                <h4 className="font-serif font-bold text-base text-[#523A2A] flex items-center gap-2">
              ...
              <button
                onClick={() => {
                  ...
                  const html = `
                    <div style="font-size: 12px; line-height: 1.6;">
                      ...
                      <hr style="border: 0; border-top: 1px solid #D9C5B2; margin: 15px 0;" />
                ...
                className="bg-[#523A2A] hover:bg-[#523A2A]/90 text-white font-serif font-bold text-xs px-4 py-2 rounded-lg shadow-xs flex items-center gap-1.5 cursor-pointer shrink-0"
              >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="bg-white p-3.5 rounded-lg border border-[#D9C5B2] space-y-1">
                <span className="text-[10px] font-bold text-[#8C7A6B] uppercase">💵 Efectivo Físico</span>
                <p className="text-sm font-mono font-bold text-[#523A2A]">
                  {formatPrice(getFilteredOrdersForMetrics().filter(o => o.paymentMethod.includes("Efectivo")).reduce((s, o) => s + o.totalAmount, 0))}
                </p>
              </div>

              <div className="bg-white p-3.5 rounded-lg border border-[#D9C5B2] space-y-1">
                <span className="text-[10px] font-bold text-[#8C7A6B] uppercase">📱 Yape / Plin / BCP</span>
                <p className="text-sm font-mono font-bold text-[#523A2A]">
              ...
              <div className="bg-white p-3.5 rounded-lg border border-[#D9C5B2] space-y-1">
                <span className="text-[10px] font-bold text-[#8C7A6B] uppercase">💳 POS / Tarjetas</span>
                <p className="text-sm font-mono font-bold text-[#523A2A]">
              ...
              <div className="bg-art-accent-5 p-3.5 rounded-lg border border-art-border space-y-1">
                ...
                <p className="text-base font-mono font-extrabold text-[#523A2A]">
        ...
        <div className="space-y-6 animate-fade-in" id="admin_tab_clients">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <button
              ...
              className="w-full md:w-auto bg-art-text hover:bg-art-accent text-white font-bold text-xs px-4 py-2.5 rounded-lg flex items-center justify-center gap-1.5 transition-colors cursor-pointer shadow-xs"
            >
                      ...
                      expandedClientId === client.id ? (
                        <tr key={`expanded-${client.id}`} className="bg-art-panel opacity-80">
                            <td colSpan={6} className="p-4 border-b border-art-border">
                              ...
                              <div className="space-y-2">
                                <h6 className="font-bold text-xs text-[#523A2A] uppercase tracking-wider flex items-center gap-1.5">
                                ...
                                {(() => {
                                  ...
                                  if (clientOrders.length === 0) {
                                    return <p className="text-xs text-[#8C7A6B] italic py-2">No hay pedidos registrados con el nombre o teléfono exacto de este cliente.</p>;
                                  }

                                  return (
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
                                      {clientOrders.map(ord => (
                                        <div key={ord.id} className="bg-[#FAF7F2] border border-[#D9C5B2] p-3 rounded-lg space-y-1.5 relative">
                                      ...
                                      {matchingNotes.length > 0 ? (
                                        matchingNotes.map(nt => (
                                          <div key={nt.id} className="bg-art-accent-5 border border-art-border p-3 rounded-lg text-xs space-y-1">
                                            ...
                                            <p className="text-[#523A2A] font-medium leading-relaxed">
                                              "{nt.note}"
                                            </p>
                                          </div>
                                        ))
                                      ) : (
                                        <p className="text-xs text-[#8C7A6B] italic">No hay notas registradas aún para este cliente.</p>
                                      )}
                                    </div>
                                  );
                                })()}
                              ...
                              <form 
                                ...
                                className="pt-2 border-t border-[#F0E6DD] flex flex-col sm:flex-row gap-2 items-center"
                              >
                                <select 
                                  name="quickChannel"
                                  className="bg-[#FAF7F2] border border-[#D9C5B2] text-xs px-2.5 py-1.5 rounded-lg text-[#523A2A] shrink-0"
                                >
                                ...
                                <input
                                  ...
                                  className="w-full bg-[#FAF7F2] border border-[#D9C5B2] text-xs px-3 py-1.5 rounded-lg text-[#523A2A]"
                                  required
                                />
                                <button
                                  type="submit"
                                  className="bg-[#523A2A] hover:bg-art-accent text-white font-bold text-xs px-3.5 py-1.5 rounded-lg shrink-0 cursor-pointer flex items-center gap-1"
                                >
          ...
          <div className="bg-[#FAF7F2] border border-[#D9C5B2] rounded-xl p-6 space-y-4 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#D9C5B2] pb-3">
              <div>
                <h4 className="font-serif font-bold text-base text-[#523A2A] flex items-center gap-2">
              ...
              <button
                ...
                className="bg-[#523A2A] hover:bg-[#523A2A]/90 text-white font-serif font-bold text-xs px-4 py-2 rounded-lg shadow-xs flex items-center justify-center gap-1.5 cursor-pointer shrink-0"
              >
            ...
            {/* Note Creation Form */}
            {showNoteForm && (
              <form onSubmit={handleSaveClientNote} className="bg-white border border-[#D9C5B2] p-4 rounded-lg space-y-3 shadow-xs animate-fade-in">
                <h5 className="font-bold text-xs text-[#523A2A] uppercase tracking-wider">Registrar Interacción con Cliente</h5>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div>
                    <label className="text-[10px] font-bold text-[#8C7A6B] uppercase">Nombre del Cliente *</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-[#8C7A6B] uppercase">Teléfono / WhatsApp</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-[10px] font-bold text-[#8C7A6B] uppercase">Vía de Contacto</label>
                    <select
                ...
                <div>
                  <label className="text-[10px] font-bold text-[#8C7A6B] uppercase">Resumen / Nota de Conversación *</label>
                  <textarea
                    rows={2}
                    placeholder="Escribe acuerdos de entrega, alergias reportadas o aclaraciones sobre el pedido..."
                    value={noteForm.note}
                    onChange={(e) => setNoteForm({ ...noteForm, note: e.target.value })}
                    className="w-full bg-[#FAF7F2] border border-[#D9C5B2] text-xs p-2 rounded-lg text-[#523A2A]"
                    required
                  />
                </div>
                ...
                <div className="flex justify-end gap-2 pt-1">
                  <button
                    type="submit"
                    className="bg-[#523A2A] hover:bg-art-accent text-white font-bold text-xs px-4 py-1.5 rounded-lg flex items-center gap-1 cursor-pointer"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {clientNotes.length > 0 ? (
                clientNotes.map((note) => (
                  <div key={note.id} className="bg-white border border-[#D9C5B2] rounded-lg p-3.5 space-y-2 shadow-2xs relative">
                    <div className="flex items-start justify-between gap-2 border-b border-[#F0E6DD] pb-2">
                      <div>
                        <h6 className="font-bold text-xs text-[#523A2A] flex items-center gap-1.5">
                        ...
                        {note.customerPhone && (
                          <span className="text-[10px] text-[#8C7A6B] font-mono">{note.customerPhone}</span>
                        )}
                      </div>
                      <button
                    ...
                    <p className="text-xs text-[#523A2A] leading-relaxed bg-[#FAF7F2] p-2.5 rounded border border-[#E8D8C8]/60">
                      "{note.note}"
                    </p>
                ...
                <div className="col-span-2 text-center text-xs text-[#8C7A6B] py-6">
                        ...
                        <td className="p-4">
                          <div className="flex flex-wrap gap-1">
                            {prov.suppliedItems.map((item, idx) => (
                              <span key={idx} className="bg-[#FAF7F2] text-art-text border border-art-border text-[9px] px-2 py-0.5 rounded-full font-medium">
                                {item}
                              </span>
                            ))}
                          </div>
        ...
        <div className="space-y-6 animate-fade-in" id="admin_tab_purchase_orders">
          <div className="bg-white border border-art-border p-6 rounded-lg shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <button
              ...
              className="bg-art-text hover:bg-art-accent text-white font-bold text-xs px-4 py-2.5 rounded-lg flex items-center justify-center gap-1.5 transition-colors cursor-pointer shrink-0 shadow-xs"
            >
        ...
        <div className="space-y-6 animate-fade-in" id="admin_tab_inventory">
          ...
          <div className="bg-white border border-art-border p-6 rounded-lg shadow-xs flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="bg-[#FAF7F2] hover:bg-[#FAF7F2]/80 border border-[#D9C5B2] text-[#523A2A] text-xs font-bold px-4 py-2.5 rounded-lg transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                      ...
                      <div className="flex flex-col gap-2 justify-center shrink-0">
                        ...
                        {matchedProvider && (
                          <button
                            ...
                            className="bg-[#FAF7F2] hover:bg-[#FAF7F2]/80 border border-[#D9C5B2] text-[#523A2A] font-bold text-[9px] px-2.5 py-1.5 rounded-lg transition-all cursor-pointer uppercase tracking-wide text-center flex items-center justify-center gap-1"
            ...
            <div className="lg:col-span-5 bg-white border border-art-border rounded-lg p-6 space-y-6 shadow-xs">
              ...
              <div className="bg-[#FAF7F2] border border-[#D9C5B2] p-4 rounded-lg space-y-2">
                <h5 className="font-serif font-bold text-xs text-[#523A2A] flex items-center gap-1.5">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full text-[10px] text-[#705845] leading-relaxed bg-white border border-[#D9C5B2] rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#A67C52] resize-y"
                />
              </div>
            </div>
              ...
              <div key={item.id} className="bg-white border border-art-border rounded-lg overflow-hidden flex flex-col justify-between shadow-xs">
                <div>
                  <div className="h-44 bg-art-panel border-b border-art-border relative flex items-center justify-center overflow-hidden">
                    ...
                    />
                    <span className="absolute top-2.5 left-2.5 text-[9px] font-bold bg-art-text text-white px-2.5 py-1 rounded-full uppercase tracking-wider">
                      {item.category === "rellenas" ? "🍪 Rellena" : 
                       item.category === "especiales" ? "✨ Autor" : 
                       item.category === "clasicas" ? "⭐ Clásica" : "☕ Bebida"}
                    </span>
                  </div>
              ...
              <div className="h-64 w-full text-xs" style={{ minHeight: '250px' }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <XAxis dataKey="month" stroke="#8C7A6B" fontSize={11} />
                    <YAxis stroke="#8C7A6B" fontSize={11} tickFormatter={(v) => `S/. ${v}`} />
                    <Tooltip 
            ...
            <div className="bg-white border border-art-border p-5 rounded-lg shadow-xs space-y-4">
              ...
              <div className="h-64 w-full text-xs" style={{ minHeight: '250px' }}>
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    <CartesianGrid strokeDasharray="3 3" stroke="#F2EDE4" />
                    <XAxis dataKey="category" stroke="#8C7A6B" fontSize={11} />
                    <YAxis stroke="#8C7A6B" fontSize={11} tickFormatter={(v) => `S/. ${v}`} />
                    <Tooltip 
                      contentStyle={{ backgroundColor: '#FAF7F2', borderColor: '#D9C5B2', borderRadius: '6px', color: '#3D2B1F' }}
                    ...
                    <Bar dataKey="Ventas" fill="var(--color-art-border)" radius={[4, 4, 0, 0]}>
                      {getSalesByCategory().map((entry, index) => {
                        const colors = ['#8C7A6B', 'var(--color-art-border)', 'var(--color-art-muted)', '#D9C5B2', '#C27D78'];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border border-art-border rounded-lg p-5 flex flex-col justify-between space-y-4">
              ...
              <button
                ...
                className="w-full bg-art-text hover:bg-art-accent text-white font-bold py-2 px-3 rounded-lg text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer animate-fade-in"
              >
            ...
            <div className="bg-white border border-art-border rounded-lg p-5 flex flex-col justify-between space-y-4">
              ...
              <button
                ...
                className="w-full bg-art-text hover:bg-art-accent text-white font-bold py-2 px-3 rounded-lg text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 bg-white border border-art-border rounded-lg p-6 space-y-5">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[10px] uppercase font-bold text-art-muted tracking-wider block flex items-center gap-1 text-[#3b5998]">
                      📘 URL de Facebook
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] uppercase font-bold text-art-muted tracking-wider block flex items-center gap-1 text-[#e1306c]">
                      📸 URL de Instagram
                    </label>
                    <input
                      type="text"
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="bg-white border border-art-border rounded-lg p-5 space-y-4">
                ...
                <div className="bg-[#FAF7F2] border border-[#D9C5B2]/60 p-4 rounded-xl text-center text-[9px] text-[#8C7A6B] space-y-3 shadow-xs">
                  <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-[10px] font-bold text-[#523A2A]">
                    <span>📍 {companyConfig.address || "(Falta dirección)"}</span>
                    <span>📞 Telf: {companyConfig.phone || "(Falta teléfono)"}</span>
                    {companyConfig.facebookUrl && <span className="text-[#3b5998] underline">📘 Facebook</span>}
                    {companyConfig.instagramUrl && <span className="text-[#e1306c] underline">📸 Instagram</span>}
                  </div>

                  <div className="text-[8px] text-[#8C7A6B]/90 space-y-1.5 border-t border-[#D9C5B2]/30 pt-2 max-w-xs mx-auto text-left leading-relaxed">
                    <span className="font-bold text-[#523A2A] uppercase tracking-wide block text-center">Términos contractuales y deslinde:</span>
                  ...
                  <div className="border-t border-[#D9C5B2]/10 pt-2 text-[8px] text-slate-400">
              ...
              <div className="bg-white border border-art-border rounded-lg p-5 space-y-4 shadow-xs">
                ...
                <form onSubmit={handleChangePassword} className="space-y-3">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-art-text hover:bg-art-accent text-white font-bold text-xs py-2.5 rounded-lg transition-colors shadow-xs cursor-pointer flex items-center justify-center gap-1.5"
                  >
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-t border-art-border pt-4">
              ...
              <div className="flex items-center gap-2 w-full md:w-auto shrink-0">
                <button
                  ...
                  className="bg-[#FAF7F2] hover:bg-[#FAF7F2]/80 border border-[#D9C5B2] text-[#523A2A] font-bold text-xs px-4 py-2.5 rounded-lg transition-all shadow-xs flex items-center gap-1.5 w-full md:w-auto justify-center cursor-pointer"
                >
      ...
      {activeTab === "advisor" && (
        <div className="space-y-6 animate-fade-in" id="admin_tab_advisor">
            ...
            <button
              ...
              className={`text-xs font-bold px-5 py-3 rounded-lg flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md select-none shrink-0 ${
                isGeneratingReport
                  ...
                  : "bg-art-accent-10 hover:bg-art-accent-5 text-[#3D2B1F]"
              }`}
            >
              {isGeneratingReport ? (
                <>
          ...
          <div className="bg-white border border-art-border rounded-lg shadow-xs overflow-hidden">
            ...
            {/* Chat Messages */}
            <div className="h-64 overflow-y-auto p-4 space-y-3 bg-[#FAF7F2]/30">
            ...
            <div className="border-t border-art-border p-3 bg-white flex gap-2">
              ...
              <button
                ...
                className="bg-art-text hover:bg-art-accent text-white p-2.5 rounded-lg transition-colors cursor-pointer"
              >
      ...
      {activeTab === "whatsapp" && (
        <div className="space-y-6 animate-fade-in" id="admin_tab_whatsapp">
          {/* Header */}
          <div className="bg-gradient-to-r from-[#075E54] to-[#128C7E] border border-[#25D366] p-6 rounded-lg shadow-md flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="space-y-1">
              <h3 className="font-serif font-bold text-lg text-white flex items-center gap-2">
                <MessageSquare className="w-5 h-5 text-[#25D366]" /> WhatsApp Business
              </h3>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-[#25D366] rounded-lg px-4 py-2 text-white text-xs font-bold">
          ...
          <div className="bg-white border border-art-border rounded-lg p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-art-border pb-3">
              ...
              <button
                ...
                className="bg-art-text hover:bg-art-accent text-white text-[10px] font-bold px-3 py-1.5 rounded-lg flex items-center gap-1 transition-colors cursor-pointer"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <div className="space-y-1 md:col-span-1">
                    ...
                    <button
                      ...
                      className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white text-xs font-bold px-3 py-2 rounded-lg transition-colors cursor-pointer"
                    >
                      Guardar
                    </button>
                  </div>
      ...
      {activeTab === "communications" && (
        <div className="space-y-6 animate-fade-in">
          <div className="gradient-art panel-soft border-art-border p-6 rounded-lg shadow-md flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="space-y-1">
              <h3 className="font-serif font-bold text-lg text-white flex items-center gap-2">
                <Headphones className="w-5 h-5 text-[#F5EDE3]" /> Agente de Comunicaciones
              </h3>
              <p className="text-xs text-white/80 leading-relaxed">
