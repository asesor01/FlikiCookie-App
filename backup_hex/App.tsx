...
export default function App() {
  ...
  // Company Configurations (editable via admin panel)
  ...
  return (
    <div id="app_root" className="min-h-screen bg-art-panel text-art-muted font-sans flex flex-col md:flex-row">
                  ...
                  return responses.slice(0, 6).map((qr: {id: string; label: string; text: string}) => (
                    <div
                      ...
                      onClick={() => {
                        ...
                        alert(`Respuesta "${qr.label}" copiada al portapapeles`);
                      }}
                      className="text-[10px] text-art-muted bg-white border border-art-border rounded-lg px-3 py-2 cursor-pointer hover:bg-art-border hover:text-art-bg hover:border-art-border transition-all"
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-x-hidden">
        ...
        {/* Desktop Header */}
        <header className="h-24 border-b border-art-border px-8 md:px-12 hidden md:flex items-center justify-between bg-white/50">
          <div>
            <h2 className="text-[13px] md:text-[14px] uppercase tracking-[0.2em] font-bold text-art-muted">
              {activeTab === "landing" && "FlikiCookie Artisan Bakery"}
          ...
          {activeTab === "designer" && (
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="space-y-1">
                <h2 className="text-base font-extrabold text-slate-800 dark:text-slate-100 flex items-center gap-2 tracking-tight uppercase">
            ...
            <div className="lg:col-span-7 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-6 space-y-6 shadow-xs" id="customizer_form">
              <div className="flex justify-between items-start border-b border-slate-150 dark:border-slate-800 pb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Define los ingredientes, tamaño y dedicatoria para el taller.</p>
                </div>
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-bold text-[#1A0F0A] flex items-center gap-1.5 uppercase">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                    {CAKE_FILLINGS.map((filling) => (
                      ...
                      >
                        <div className="font-bold flex items-center gap-1.5 text-sm text-[#1A0F0A]">
                          {filling.label}
                          {filling.priceModifier > 0 && (
                            <span className="text-[10px] bg-[#E91E8C]/15 text-[#E91E8C] font-bold px-1.5 py-0.2 rounded">+{formatPrice(filling.priceModifier)}</span>
                          )}
                        </div>
                        <p className="text-[11px] text-[#5D4E37] font-semibold leading-relaxed mt-0.5">{filling.desc}</p>
                      </button>
                    ))}
                  </div>
                </div>
                      ...
                      return (
                        <button
                          ...
                          className={`p-2.5 rounded-xl border text-center transition-all cursor-pointer flex flex-col items-center gap-1 ${
                            isSelected
                              ? "bg-[#E91E8C]/15 border-[#E91E8C] text-[#E91E8C] font-bold"
                              : "bg-white hover:bg-art-panel border-art-border text-art-text text-xs font-semibold"
                          }`}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-art-border text-art-text text-sm px-4 py-3 rounded-xl focus:outline-none focus:ring-1.5 focus:ring-art-accent placeholder-[#5D4E37] font-serif italic"
                    maxLength={30}
                    id="input_inscription"
                  />
                  <div className="flex justify-between items-center text-[10px] text-[#5D4E37] font-semibold px-1">
              ...
              <div className="pt-4 border-t border-slate-150 dark:border-slate-800/80 flex items-center justify-between">
                <div className="hidden md:block">
                  ...
                  <p className="text-xs font-semibold text-slate-600 dark:text-slate-300 capitalize">{customSpec.tiers} Piso(s), Masa {customSpec.flavor}</p>
                </div>
        ...
        {activeTab === "catalog" && (
          <div className="space-y-4 animate-fade-in" id="view_catalog">
            <div className="space-y-1">
              <h2 className="text-base font-extrabold text-slate-800 dark:text-slate-100 uppercase tracking-tight flex items-center gap-2">
            ...
            <Catalog onAddToCart={handleAddCatalogItem} menuItems={menuItems} />
          </div>
        )}
        ...
        {activeTab === "faq" && (
          <div className="space-y-4 animate-fade-in" id="view_faq">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 border-b border-[#D9C5B2] pb-3">
              <div>
                <h2 className="text-base font-extrabold text-[#2C1810] uppercase tracking-tight flex items-center gap-2">
                  <HelpCircle className="w-5 h-5 text-[#8B5E3C]" /> Preguntas Frecuentes
                </h2>
        ...
        {activeTab === "reviews" && (
          <div className="space-y-4 animate-fade-in" id="view_reviews">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 border-b border-[#D9C5B2] pb-3">
              <div>
                <h2 className="text-base font-extrabold text-[#2C1810] uppercase tracking-tight flex items-center gap-2">
                  <Star className="w-5 h-5 text-[#8B5E3C]" /> Opiniones de Clientes
                </h2>
                <p className="text-xs text-[#8C7A6B]">
        ...
        {activeTab === "admin" && (
          <div className="space-y-4 animate-fade-in" id="view_admin">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
              <div>
                <h2 className="text-base font-extrabold text-slate-800 dark:text-slate-100 uppercase tracking-tight flex items-center gap-2">
      ...
      <footer className="bg-art-panel/60 border-t border-art-border px-6 py-8 text-center text-[10px] text-art-muted font-medium space-y-4">
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-[11px] font-serif font-bold text-[#523A2A]">
          <span>📍 {companyConfig.address}</span>
          <span>📞 Telf: {companyConfig.phone}</span>
          {companyConfig.facebookUrl && (
            <a href={companyConfig.facebookUrl} target="_blank" rel="noreferrer" className="hover:underline flex items-center gap-1 text-[#3b5998]">
              📘 Facebook
            </a>
          )}
          {companyConfig.instagramUrl && (
            <a href={companyConfig.instagramUrl} target="_blank" rel="noreferrer" className="hover:underline flex items-center gap-1 text-[#e1306c]">
              📸 Instagram
            </a>
          )}
        </div>
        
        <div className="max-w-xl mx-auto px-4 text-[9px] text-[#8C7A6B]/90 leading-relaxed border-t border-[#D9C5B2]/40 pt-3 space-y-2">
          <p className="font-bold uppercase tracking-wider mb-0.5 text-[#523A2A]">Aviso & Condiciones de Venta:</p>
          <p className="italic text-left bg-white/30 p-2.5 rounded border border-[#D9C5B2]/20 shadow-2xs whitespace-pre-line">{companyConfig.disclaimer}</p>
          <p className="whitespace-pre-line text-left bg-white/50 p-2.5 rounded border border-[#D9C5B2]/30 shadow-2xs">{companyConfig.termsOfService}</p>
        </div>

        <div className="border-t border-[#D9C5B2]/20 pt-3 space-y-1">
              ...
              {cart.length > 0 ? (
                <div className="space-y-4">
                  ...
                  {cart.map((item) => {
                    ...
                    return (
                      <div key={item.id} className="border border-slate-150 dark:border-slate-800 p-3.5 rounded-xl bg-slate-50/50 dark:bg-slate-850/50 space-y-2 text-xs flex justify-between gap-4">
                        <div className="space-y-1.5 flex-1">
                          ...
                          {item.isCustom && item.customSpec && (
                            <div className="text-[10px] text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-800 p-2 rounded-lg leading-relaxed">
                      ...
                      <div className="flex flex-col items-center justify-between h-20 shrink-0">
                        ...
                        <div className="flex items-center gap-2 border border-slate-200 dark:border-slate-700 rounded-lg p-1 bg-white dark:bg-slate-900">
                          <button
                            ...
                            className="w-5 h-5 flex items-center justify-center bg-slate-100 hover:bg-slate-250 dark:bg-slate-800 dark:hover:bg-slate-750 text-slate-600 dark:text-slate-300 rounded font-bold cursor-pointer"
                          >
                            -
                          </button>
                  ...
                  <div className="bg-art-panel p-3 rounded-xl border border-art-border space-y-2">
                    <div className="flex justify-between items-center text-xs">
                      <span className="font-serif font-bold text-[#523A2A] flex items-center gap-1">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 bg-white border border-[#D9C5B2] text-xs px-3 py-1.5 rounded-lg focus:outline-none focus:ring-1 focus:ring-art-accent uppercase font-mono"
                  ...
                  <div className="pt-3 border-t border-slate-200 dark:border-slate-800 space-y-1.5 text-xs">
                    ...
                    <div className="flex justify-between items-center font-extrabold text-slate-800 dark:text-slate-100 text-sm pt-2 border-t border-slate-100">
                  ...
                  <form onSubmit={handlePlaceOrder} className="pt-4 border-t border-slate-200 dark:border-slate-800 space-y-4">
                    ...
                    <div className="space-y-3.5 text-xs">
                      ...
                      <div className="space-y-1">
                        <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">Tipo de Comprobante SUNAT</label>
                        ...
                        <div className="grid grid-cols-2 gap-2 p-3 bg-art-accent-10 border border-art-border rounded-xl animate-fade-in">
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              className="w-full bg-white border border-art-border text-xs px-2.5 py-1.5 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#E91E8C] font-mono"
                            />
                          </div>
                          <div className="space-y-1">
                            ...
                            <input
                              ...
                              className="w-full bg-white border border-art-border text-xs px-2.5 py-1.5 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#E91E8C]"
                            />
                          </div>
                        </div>
                      )}
                      ...
                      {/* Name input */}
                      <div className="space-y-1">
                        <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">Nombre Completo / Titular</label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-850 text-slate-800 dark:text-slate-100 text-xs pl-10 pr-4 py-2.5 rounded-xl focus:outline-none focus:ring-1.5 focus:ring-[#E91E8C] placeholder-slate-400"
                            id="checkout_name"
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">WhatsApp / Teléfono</label>
                        <div className="relative">
                      ...
                      {/* Email input */}
                      <div className="space-y-1">
                        <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">Correo Electrónico</label>
                        <div className="relative">
                      ...
                      <div className="space-y-1">
                        <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">Modalidad de Entrega</label>
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <button
                              ...
                              className={`py-2 rounded-xl border font-semibold text-center cursor-pointer transition-colors ${
                                checkoutForm.orderType === opt
                                  ? "bg-art-accent-10 border-art-accent text-art-accent dark:text-art-accent"
                                  : "bg-slate-50 dark:bg-slate-850 border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400"
                              }`}
                      ...
                      {checkoutForm.orderType === "Entrega a Domicilio" && (
                        <div className="space-y-1 animate-fade-in">
                          <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">Dirección de Despacho</label>
                          <div className="relative">
                            ...
                            <textarea
                              ...
                              rows={2}
                              className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-850 text-slate-800 dark:text-slate-100 text-xs pl-10 pr-4 py-2 focus:outline-none focus:ring-1.5 focus:ring-[#E91E8C] placeholder-slate-400"
                              id="checkout_address"
                            />
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                          <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">📅 Fecha</label>
                          <input
                            type="date"
                            required
                            value={checkoutForm.deliveryDate}
                            onChange={(e) => setCheckoutForm(prev => ({ ...prev, deliveryDate: e.target.value }))}
                            className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-850 text-slate-800 dark:text-slate-100 text-xs p-2.5 rounded-xl focus:outline-none focus:ring-1.5 focus:ring-[#E91E8C] text-center"
                            id="checkout_date"
                          />
                        </div>

                        <div className="space-y-1">
                          <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">⏰ Hora Pactada</label>
                          <input
                            type="time"
                            required
                      ...
                      {/* Payment Method */}
                      <div className="space-y-1">
                        <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px] block">💳 Método de Pago</label>
                        <div className="relative">
                          <select
                            value={checkoutForm.paymentMethod}
                            onChange={(e) => setCheckoutForm(prev => ({ ...prev, paymentMethod: e.target.value as any }))}
                            className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-100 text-xs p-2.5 rounded-xl focus:outline-none focus:ring-1.5 focus:ring-[#E91E8C] appearance-none font-semibold"
                      ...
                      <div className="space-y-1">
                        <label className="font-bold text-slate-500 dark:text-slate-400 uppercase text-[10px]">N° Operación / Referencia de Pago (Opcional)</label>
                        <input
                          type="text"
                          ...
                          className="w-full bg-slate-50 dark:bg-slate-850 border border-slate-200 text-slate-800 text-xs px-3 py-2 rounded-xl focus:outline-none focus:ring-1.5 focus:ring-[#E91E8C] font-mono"
                      ...
                      {/* Dynamic Admin-Configured Instructions */}
                        ...
                        <p className="text-[9.5px] text-slate-600 dark:text-slate-400 whitespace-pre-line leading-relaxed">
                    ...
                    <div className="space-y-2 border-t border-slate-100 dark:border-slate-800/80 pt-3 px-1 text-left">
                      <div className="bg-slate-50 dark:bg-slate-850 p-2.5 rounded-lg border border-slate-200/50 dark:border-slate-800">
                        <span className="text-[9px] font-bold text-art-muted uppercase tracking-wide block mb-0.5">⚠️ Nota Legal y Alérgenos:</span>
                        <p className="text-[8.5px] text-slate-500 dark:text-slate-400 leading-relaxed italic line-clamp-3 hover:line-clamp-none transition-all cursor-pointer">
                      ...
                      <label className="flex items-start gap-2 cursor-pointer select-none">
                        <input 
                          type="checkbox" 
                          required 
                          className="mt-0.5 rounded text-art-accent focus:ring-[#E91E8C] cursor-pointer h-3.5 w-3.5" 
                        />
                        <span className="text-[9.5px] text-art-muted font-medium leading-tight">
                          Acepto las <strong className="text-art-accent dark:text-art-accent underline">Condiciones de Servicio</strong> de {companyConfig.companyName}
                        </span>
                      </label>
                    </div>
                ...
                <div className="h-full flex flex-col items-center justify-center text-center p-6 py-20 space-y-3">
                  ...
                  <h4 className="font-bold text-slate-800 dark:text-slate-200 text-sm">Tu carrito está vacío</h4>
      ...
      {placedOrder && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 animate-fade-in" id="order_placed_modal">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 text-center max-w-md w-full space-y-5 shadow-2xl">
            <div className="w-16 h-16 bg-emerald-500/10 text-emerald-500 dark:text-emerald-400 rounded-full flex items-center justify-center text-3xl mx-auto border-2 border-emerald-500 animate-bounce">
              ✓
            </div>

            <div className="space-y-1">
              <h3 className="font-extrabold text-slate-800 dark:text-slate-100 text-base tracking-tight">🎉 ¡Pedido Registrado con Éxito!</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Tu solicitud ha ingresado de forma exitosa a nuestro taller de repostería artesanal.
              </p>
            </div>

              <div className="bg-slate-50 dark:bg-slate-850 p-4 rounded-xl border border-slate-200/40 dark:border-slate-800 font-mono text-xs space-y-1.5 text-slate-700 dark:text-slate-300">
            ...
            <div className="flex gap-2.5">
              ...
              <button
                ...
                className="bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 font-bold text-xs py-3 px-4 rounded-xl transition-all cursor-pointer"
              >
                Entendido
              </button>
            </div>
