              ...
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] text-art-brown">{msg.timestamp}</span>
                  </div>
                </div>
          ...
          {showAddForm && (
            <div className="bg-art-panel border border-art-border rounded-xl p-4 space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div>
                  <label className="text-[9px] uppercase font-bold text-art-brown">Canal</label>
                  <select
              ...
              <div>
                <label className="text-[9px] uppercase font-bold text-art-brown">Respuesta Automática</label>
                <textarea
                  rows={2}
            ...
            {autoResponses.map(ar => (
              <div key={ar.id} className="bg-white border border-art-border rounded-xl p-4 flex items-center justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-xs text-art-deep">"{ar.trigger}"</span>
                  ...
                  <p className="text-[10px] text-art-brown mt-1 line-clamp-1">{ar.response}</p>
                </div>
